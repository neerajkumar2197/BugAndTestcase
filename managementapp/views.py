...
def add_task(request):
    ...
    return render(request, "add_task.html", {"mngr_email": mngr_email, "details_emply": details_emply ,"details_project":details_project})
...
def edit_task(request, id):
    ...
    details_emply = Employee.objects.all().exclude(role="manager")
    details_project = Project.objects.all()
    return render(request, "edit_task.html", {"mngr_email": mngr_email, "details_emply": details_emply, "tasks": tasks ,"details_project":details_project})
